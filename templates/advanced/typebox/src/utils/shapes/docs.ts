...
export const docs = new DocsShape()
    .setOpenAPIOptions({ helperSchemaProperty: SCHEMA_PROPERTY, helperClass: OpenAPIJsonHelper })
    .setPostmanOptions({ helperSchemaProperty: SCHEMA_PROPERTY, helperClass: PostmanJsonHelper })
    .setPath(DOC_PATH)
    .setHost({
        url: HOST,
